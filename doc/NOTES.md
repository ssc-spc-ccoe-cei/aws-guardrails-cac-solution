...
The following lambda function (starting with aws_ prefix) are used to prepare the base environment, including Audit Manager, S3, IAM and AWS Config resources setup.
