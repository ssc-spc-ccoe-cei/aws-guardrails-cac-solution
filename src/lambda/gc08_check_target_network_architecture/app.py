    ...
    if is_scheduled_notification(invoking_event["messageType"]):
        ...
        if AWS_ACCOUNT_ID == AUDIT_ACCOUNT_ID:
            ...
            if check_s3_object_exists(valid_rule_parameters["s3ObjectPath"]):
                ...
                custom_annotation = "Target Network Architecture document found"
            else:
                compliance_value = "NON_COMPLIANT"
                custom_annotation = "Target Network Architecture document NOT found"
            ...
            logger.info("Target Network Architecture document not checked in account %s - not the Audit account", AWS_ACCOUNT_ID)
