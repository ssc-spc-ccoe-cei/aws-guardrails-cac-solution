""" GC09 - Check NetSec Architecture
    https://canada-ca.github.io/cloud-guardrails/EN/09_Network-Security-Services.html
"""
import json
import logging
import re
    ...
    if is_scheduled_notification(invoking_event["messageType"]):
        ...
        if AWS_ACCOUNT_ID == AUDIT_ACCOUNT_ID:
            ...
            if check_s3_object_exists(valid_rule_parameters["s3ObjectPath"]):
                ...
                custom_annotation = "Network Security Architecture document found"
            else:
                compliance_value = "NON_COMPLIANT"
                custom_annotation = "Network Security Architecture document NOT found"
            ...
            logger.info("Network Security Architecture document not checked in account %s - not the Audit account", AWS_ACCOUNT_ID)
