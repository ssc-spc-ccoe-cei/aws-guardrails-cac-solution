...
def check_guardrail_rquirement_by_cloud_usage_profile(guardrail: GuardrailType, account_cloud_profile: CloudProfileType) -> GuardrailRequirementType:        
...
def get_cloud_profile_from_tags(tags: list[dict]) -> CloudProfileType:
    tagKey = "CloudProfile"
    default = CloudProfileType.Profile6
    try:
        default = CloudProfileType(os.environ.get("DEFAULT_CLOUD_PROFILE", CloudProfileType.Profile6))
    except:
