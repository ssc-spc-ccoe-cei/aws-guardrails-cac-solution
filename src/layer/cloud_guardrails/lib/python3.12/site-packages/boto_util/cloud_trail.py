...
def trails_are_logging(cloud_trail_client, trails, interval_between_calls: float = 0.01):
    for t in trails:
        try:
...
def lookup_cloud_trail_events(cloud_trail_client, lookup_attributes: list[dict] | None = None, interval_between_calls: float = 0.1) -> list[dict]:
    try:
        args = {}
        resources = []
