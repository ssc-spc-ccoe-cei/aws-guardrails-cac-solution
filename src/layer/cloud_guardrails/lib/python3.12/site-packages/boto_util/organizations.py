...
def get_account_tags(organizations_client, account_id):
    tags = []
    next_token = None
    while True:
        response = organizations_client.list_tags_for_resource(ResourceId=account_id, NextToken=next_token) if next_token else organizations_client.list_tags_for_resource(ResourceId=account_id)
        tags = tags + response.get("Tags")
