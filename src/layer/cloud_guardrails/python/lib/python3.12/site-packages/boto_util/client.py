...
def get_client(service, event, assume_role_mode, role_name, account_id, audit_account_id):
    ...
    audit_account_id -- the id of the audit account
    """
    if not assume_role_mode or (account_id == audit_account_id):
